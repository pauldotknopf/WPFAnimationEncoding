...
namespace WPFAnimationEncoding
{
	...
	*/
	...
	int Sandbox::Test(System::String^ inputFile, System::String^ outputFile)
	{
		/*System::IntPtr nativeInputFileNamePointer = System::Runtime::InteropServices::Marshal::StringToHGlobalAnsi(inputFile);
		char* nativeInputFileName = static_cast<char*>(nativeInputFileNamePointer.ToPointer());

		System::IntPtr nativeOutputFileNamePointer = System::Runtime::InteropServices::Marshal::StringToHGlobalAnsi(outputFile);
